[![build](https://github.com/iRatePiRat3/SimpleArithmetic/actions/workflows/lake-build.yml/badge.svg)](https://github.com/iRatePiRat3/SimpleArithmetic/actions/workflows/lake-build.yml)
